...
result_1 = write_file_confirmed(working_dir, existing_file, content_v1, dry_run=True, run_id=run_id )
print(result_1)
...
result_6 = write_file_confirmed(working_dir, new_file, content_v4, log_changes=False, run_id=run_id )
print(result_6)

# 7. Verbose mode with function_args manually passed, new file creation dry run on
...
# 8. Verbose mode with function_args manually passed, actual creation of new file
print("\n\u25B6\uFE0F Test 8: verbose mode with function_args")
manual_args = {
    "working_directory": working_dir,
    "file_path": "manual_verbose.py",
    "content": content_v6,
